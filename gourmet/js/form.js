...
function myFunction()  // Function to check if firstname and lastname empty then call MyFunction3
    ...
    function myFunction3() // Function to display information of order after user send order under main.html
    {
          var a =" Thank you for the order and we shall contact you shortly."
          var x = document.myform.firstname.value;
          var y = document.myform.lastname.value;
          var z = "You have selected " + document.myform.menu.value;
          document.getElementById("thankyou_display").innerHTML = "Hello " + x + " " + y +". " + z +" " + a;
          CallTwo();
        }   
     

    function sendMail() {   // open up Mail client and send email
            window.location = "mailto:info@gourmetparadise.com?body=Dear Gourmet Paradise; .. &subject=Information Request - Gourmet Paradise";
        }